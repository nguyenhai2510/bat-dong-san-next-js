            ...
            <div className="flex bg-white shadow py-2 items-center sticky top-[60px] z-40">
                <div className="flex px-5 font-bold  ">
                    <Link href={'/house-of-sale'}
                          className={`px-3 py-1  rounded-l w-[100px] text-center ${location.includes('house-of-sale') ? 'text-white bg-gray-600' : 'border border-r-0'}`}>Bán</Link>
                    <Link href={'/house-for-rent'}
                          className={`px-3 py-1  rounded-r w-[100px] text-center ${location.includes('house-for-rent') ? 'text-white bg-gray-600' : 'border border-l-0'}`}>Cho thuê</Link>
                </div>
